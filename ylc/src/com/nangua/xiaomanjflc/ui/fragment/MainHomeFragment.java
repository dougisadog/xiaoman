...
//			String addGain = product.getActivityRate();
			//TODO DELETE
			String addGain = "0.9";
//			String rateCoupon = "0.01";
			String rateCoupon = product.getRateSubsidy();
			product.setActivity(1);
...
//			String recommendTitle = product.getRecommendTitle();
			...
			if (i==0) {
				...
				if (product.getActivity() != 0
						&& !StringUtils.isEmpty(addGain)) {
					//替换显示为 加息之和
//					percentIcon1.setVisibility(View.GONE);
//					add_v1.setVisibility(View.VISIBLE);
//					add1.setText(addGain);
					annualizedGain1.setText(Float.parseFloat(gain) + Float.parseFloat(addGain) + Float.parseFloat(rateCoupon) + "");
				}
				else {
...
//					add2.setText(addGain);
					annualizedGain2.setText(Float.parseFloat(gain) + Float.parseFloat(addGain) + Float.parseFloat(rateCoupon) + "");
				}
				else {
...
//					add3.setText(addGain);
					annualizedGain3.setText(Float.parseFloat(gain) + Float.parseFloat(addGain) + Float.parseFloat(rateCoupon) + "");
				}
				else {
