...
public class KJListViewHeader extends LinearLayout {
	...
	// widget
	private FontTextView hintTextView; // 刷新提示文字（上拉刷新、下拉刷新、正在刷新）
	RelativeLayout layout; // 头部layout
	FontTextView timeTextView; // 刷新时间
	...
	private void initView(Context context) {
		...
		hintTextView = new FontTextView(context);
		hintTextView.setGravity(Gravity.CENTER);
		hintTextView.setText(normal);
		timeTextView = new FontTextView(context);
